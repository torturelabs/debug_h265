...
void ff_hevc_put_unweighted_pred_wasm(uint8_t *_dst, ptrdiff_t _dststride,
                                     const int16_t *src, ptrdiff_t srcstride,
                                     int width, int height) {
  int x, y;
  uint8_t *dst = (uint8_t *)_dst;
...
void ff_hevc_put_weighted_pred_avg_wasm(uint8_t *_dst, ptrdiff_t _dststride,
...
#if 0
void ff_hevc_weighted_pred_8_wasm4(uint8_t denom, int16_t wlxFlag, int16_t olxFlag,
...
#if 0
void ff_hevc_weighted_pred_wasm(uint8_t denom, int16_t wlxFlag, int16_t olxFlag,
                               uint8_t *_dst, ptrdiff_t _dststride,
                               const int16_t *src, ptrdiff_t srcstride,
                               int width, int height) {
...
#if HAVE_SSE4_1
void ff_hevc_weighted_pred_avg_8_wasm4(uint8_t denom, int16_t wl0Flag,
                                      int16_t wl1Flag, int16_t ol0Flag,
                                      int16_t ol1Flag, uint8_t *_dst,
                                      ptrdiff_t _dststride, const int16_t *src1,
...
#if 0
void ff_hevc_weighted_pred_avg_wasm(uint8_t denom, int16_t wl0Flag,
...
void ff_hevc_put_hevc_epel_pixels_10_wasm(int16_t *dst, ptrdiff_t dststride,
                                         const uint8_t *_src,
                                         ptrdiff_t _srcstride, int width,
                                         int height, int mx, int my,
                                         int16_t *mcbuffer) {
  int x, y;
  __m128i x2;
...
void ff_hevc_put_hevc_epel_h_8_wasm(int16_t *dst, ptrdiff_t dststride,
  ...
  r0 = _mm_set_epi8(filter_3, filter_2, filter_1, filter_0, filter_3, filter_2,
                    filter_1, filter_0, filter_3, filter_2, filter_1, filter_0,
                    filter_3, filter_2, filter_1, filter_0);
...
#ifndef __native_client__
void ff_hevc_put_hevc_epel_h_10_wasm(int16_t *dst, ptrdiff_t dststride,
                                    const uint8_t *_src, ptrdiff_t _srcstride,
                                    int width, int height, int mx, int my,
                                    int16_t *mcbuffer) {
  int x, y;
  ...
  int8_t filter_2 = filter[2];
  int8_t filter_3 = filter[3];
  r0 = _mm_set_epi16(filter_3, filter_2, filter_1, filter_0, filter_3, filter_2,
                     filter_1, filter_0);
  bshuffle1 = _mm_set_epi8(9, 8, 7, 6, 5, 4, 3, 2, 7, 6, 5, 4, 3, 2, 1, 0);

  if (!(width & 3)) {
    bshuffle2 =
        _mm_set_epi8(13, 12, 11, 10, 9, 8, 7, 6, 11, 10, 9, 8, 7, 6, 5, 4);
    for (y = 0; y < height; y++) {
      for (x = 0; x < width; x += 4) {
...
#ifndef __native_client__
void ff_hevc_put_hevc_epel_v_10_wasm(int16_t *dst, ptrdiff_t dststride,
                                    const uint8_t *_src, ptrdiff_t _srcstride,
                                    int width, int height, int mx, int my,
                                    int16_t *mcbuffer) {
  int x, y;
...
void ff_hevc_put_hevc_epel_hv_8_wasm(int16_t *dst, ptrdiff_t dststride,
  ...
  __m128i r0, bshuffle1, bshuffle2, x0, x1, x2, x3, t0, t1, t2, t3, f0, f1, f2,
      f3, r1, r2;
...
#ifndef __native_client__
void ff_hevc_put_hevc_epel_hv_10_wasm(int16_t *dst, ptrdiff_t dststride,
                                     const uint8_t *_src, ptrdiff_t _srcstride,
                                     int width, int height, int mx, int my,
                                     int16_t *mcbuffer) {
  int x, y;
...
#ifndef __native_client__
void ff_hevc_put_hevc_qpel_pixels_10_wasm(int16_t *dst, ptrdiff_t dststride,
                                         const uint8_t *_src,
                                         ptrdiff_t _srcstride, int width,
                                         int height, int16_t *mcbuffer) {
  int x, y;
...
#ifndef __native_client__
/*
 * @TODO : Valgrind to see if it's useful to use SSE or wait for AVX2
 * implementation
 */
void ff_hevc_put_hevc_qpel_h_1_10_wasm(int16_t *dst, ptrdiff_t dststride,
                                      const uint8_t *_src, ptrdiff_t _srcstride,
                                      int width, int height,
                                      int16_t *mcbuffer) {
  int x, y;
  ...
  for (y = 0; y < height; y++) {
    for (x = 0; x < width; x += 2) {
      x1 = _mm_loadu_si128((__m128i *)&src[x - 3]);
      x2 = _mm_srli_si128(
          x1, 2); // last 16bit not used so 1 load can be used for 2 dst
...
void ff_hevc_put_hevc_qpel_h_2_8_wasm(int16_t *dst, ptrdiff_t dststride,
  ...
  r0 = _mm_set_epi8(-1, 4, -11, 40, 40, -11, 4, -1, -1, 4, -11, 40, 40, -11, 4,
                    -1);
...
#if 0
static void ff_hevc_put_hevc_qpel_h_2_wasm(int16_t *dst, ptrdiff_t dststride,
...
static void ff_hevc_put_hevc_qpel_h_3_wasm(int16_t *dst, ptrdiff_t dststride,
                                          const uint8_t *_src, ptrdiff_t _srcstride, int width, int height,
        int16_t* mcbuffer) {
    int x, y;
    uint8_t *src = _src;
...
/**
 for column MC treatment, we will calculate 8 pixels at the same time by
 multiplying the values of each row.
  ...
  if (!(width & 15)) {
    ...
    for (y = 0; y < height; y++) {
      for (x = 0; x < width; x += 16) {
        ...
        r0 = _mm_adds_epi16(
            r0, _mm_mullo_epi16(t2, _mm_set1_epi16(_mm_extract_epi16(r1, 1))));
        r2 = _mm_adds_epi16(
            r2, _mm_mullo_epi16(x2, _mm_set1_epi16(_mm_extract_epi16(r1, 1))));
        r0 = _mm_adds_epi16(
            r0, _mm_mullo_epi16(t3, _mm_set1_epi16(_mm_extract_epi16(r1, 2))));
        r2 = _mm_adds_epi16(
            r2, _mm_mullo_epi16(x3, _mm_set1_epi16(_mm_extract_epi16(r1, 2))));

        r0 = _mm_adds_epi16(
            r0, _mm_mullo_epi16(t4, _mm_set1_epi16(_mm_extract_epi16(r1, 3))));
        r2 = _mm_adds_epi16(
            r2, _mm_mullo_epi16(x4, _mm_set1_epi16(_mm_extract_epi16(r1, 3))));

        r0 = _mm_adds_epi16(
            r0, _mm_mullo_epi16(t5, _mm_set1_epi16(_mm_extract_epi16(r1, 4))));
        r2 = _mm_adds_epi16(
            r2, _mm_mullo_epi16(x5, _mm_set1_epi16(_mm_extract_epi16(r1, 4))));

        r0 = _mm_adds_epi16(
            r0, _mm_mullo_epi16(t6, _mm_set1_epi16(_mm_extract_epi16(r1, 5))));
        r2 = _mm_adds_epi16(
            r2, _mm_mullo_epi16(x6, _mm_set1_epi16(_mm_extract_epi16(r1, 5))));

        r0 = _mm_adds_epi16(
            r0, _mm_mullo_epi16(t7, _mm_set1_epi16(_mm_extract_epi16(r1, 6))));
        r2 = _mm_adds_epi16(
            r2, _mm_mullo_epi16(x7, _mm_set1_epi16(_mm_extract_epi16(r1, 6))));
    ...
    for (y = 0; y < height; y++) {
      for (x = 0; x < width; x += 4) {
        ...
        r0 = _mm_adds_epi16(
            r0, _mm_mullo_epi16(x3, _mm_set1_epi16(_mm_extract_epi16(r1, 2))));

        r0 = _mm_adds_epi16(
            r0, _mm_mullo_epi16(x4, _mm_set1_epi16(_mm_extract_epi16(r1, 3))));

        r0 = _mm_adds_epi16(
            r0, _mm_mullo_epi16(x5, _mm_set1_epi16(_mm_extract_epi16(r1, 4))));

        r0 = _mm_adds_epi16(
            r0, _mm_mullo_epi16(x6, _mm_set1_epi16(_mm_extract_epi16(r1, 5))));

        r0 = _mm_adds_epi16(
            r0, _mm_mullo_epi16(x7, _mm_set1_epi16(_mm_extract_epi16(r1, 6))));
...
#if 0
void ff_hevc_put_hevc_qpel_v_1_10_wasm4(int16_t *dst, ptrdiff_t dststride,
                                       const uint8_t *_src, ptrdiff_t _srcstride, int width, int height,
        int16_t* mcbuffer) {
    int x, y;
    uint16_t *src = (uint16_t*) _src;
  ...
  if (!(width & 15)) {
    for (y = 0; y < height; y++) {
      for (x = 0; x < width; x += 16) {
        ...
        r0 = _mm_adds_epi16(
            r0, _mm_mullo_epi16(t8, _mm_set1_epi16(_mm_extract_epi16(r1, 7))));
        r2 = _mm_adds_epi16(
            r2, _mm_mullo_epi16(x8, _mm_set1_epi16(_mm_extract_epi16(r1, 7))));
    ...
    for (y = 0; y < height; y++) {
      for (x = 0; x < width; x += 4) {
        ...
        r0 = _mm_adds_epi16(
            r0, _mm_mullo_epi16(x8, _mm_set1_epi16(_mm_extract_epi16(r1, 7))));
...
#if 0
void ff_hevc_put_hevc_qpel_v_2_10_wasm(int16_t *dst, ptrdiff_t dststride,
...
#if 0
static  void ff_hevc_put_hevc_qpel_v_3_wasm(int16_t *dst, ptrdiff_t dststride,
                                           const uint8_t *_src, ptrdiff_t _srcstride, int width, int height,
        int16_t* mcbuffer) {
    int x, y;
    uint8_t *src = (uint8_t*) _src;
...
#if 0
void ff_hevc_put_hevc_qpel_v_3_10_wasm(int16_t *dst, ptrdiff_t dststride,
                                      const uint8_t *_src, ptrdiff_t _srcstride, int width, int height,
        int16_t* mcbuffer) {
    int x, y;
    uint16_t *src = (uint16_t*) _src;
...
void ff_hevc_put_hevc_qpel_h_1_v_1_wasm(int16_t *dst, ptrdiff_t dststride,
  ...
  /* vertical treatment on temp table : tmp contains 16 bit values, so need to
   use 32 bit  integers for register calculations */
  ...
  for (y = 0; y < height; y++) {
    for (x = 0; x < width; x += 8) {
      ...
      t8 = _mm_unpacklo_epi16(
          _mm_mullo_epi16(x8, _mm_set1_epi16(_mm_extract_epi16(rTemp, 7))),
          _mm_mulhi_epi16(x8, _mm_set1_epi16(_mm_extract_epi16(rTemp, 7))));
